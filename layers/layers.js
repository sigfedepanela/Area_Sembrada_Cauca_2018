...
jsonSource_reaSembradadeCaaPaneleraHectareas_2.addFeatures(features_reaSembradadeCaaPaneleraHectareas_2);var lyr_reaSembradadeCaaPaneleraHectareas_2 = new ol.layer.Vector({
    ...
    <img src="styles/legend/reaSembradadeCaaPaneleraHectareas_2_0.png" />  20 - 160 <br />\
    <img src="styles/legend/reaSembradadeCaaPaneleraHectareas_2_1.png" />  160 - 490 <br />\
    <img src="styles/legend/reaSembradadeCaaPaneleraHectareas_2_2.png" />  490 - 980 <br />\
    <img src="styles/legend/reaSembradadeCaaPaneleraHectareas_2_3.png" />  980 - 2190 <br />\
    <img src="styles/legend/reaSembradadeCaaPaneleraHectareas_2_4.png" />  2190 - 3390 <br />'
        });
...
lyr_reaSembradadeCaaPaneleraHectareas_2.set('fieldAliases', {'DEPARTAMEN': 'DEPARTAMEN', 'MUNICIPIO': 'MUNICIPIO', 'CULTIVO': 'CULTIVO', 'AÑO': 'AÑO', 'A.SEM.(Ha)': 'A.SEM.(Ha)', 'A.COS.(Ha)': 'A.COS.(Ha)', 'PROD.(Ton)': 'PROD.(Ton)', 'REND.(Ton/': 'REND.(Ton/', });
...
lyr_reaSembradadeCaaPaneleraHectareas_2.set('fieldImages', {'DEPARTAMEN': 'TextEdit', 'MUNICIPIO': 'TextEdit', 'CULTIVO': 'TextEdit', 'AÑO': 'TextEdit', 'A.SEM.(Ha)': 'TextEdit', 'A.COS.(Ha)': 'TextEdit', 'PROD.(Ton)': 'TextEdit', 'REND.(Ton/': 'TextEdit', });
...
lyr_reaSembradadeCaaPaneleraHectareas_2.set('fieldLabels', {'DEPARTAMEN': 'inline label', 'MUNICIPIO': 'inline label', 'CULTIVO': 'inline label', 'AÑO': 'inline label', 'A.SEM.(Ha)': 'inline label', 'A.COS.(Ha)': 'inline label', 'PROD.(Ton)': 'inline label', 'REND.(Ton/': 'inline label', });
